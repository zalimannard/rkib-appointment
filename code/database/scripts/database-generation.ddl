...
ALTER TABLE appointment_status_types ADD CONSTRAINT appointment_status_types_PK PRIMARY KEY ( id );
...
ALTER TABLE appointment_statuses ADD CONSTRAINT appointment_statuses_PK PRIMARY KEY ( id );
...
CREATE TABLE patients (
    ...
    first_name     VARCHAR2(30 CHAR) NOT NULL,
    middle_name    VARCHAR2(30 CHAR) NOT NULL,
    "phone number" VARCHAR2(20 CHAR) NOT NULL,
...
ALTER TABLE appointment_statuses
    ADD CONSTRAINT appointment_statuses_appointment_status_types_FK FOREIGN KEY ( type_id )
        REFERENCES appointment_status_types ( id );

ALTER TABLE appointments
    ADD CONSTRAINT appointments_appointment_statuses_FK FOREIGN KEY ( appointment_status_id )
        REFERENCES appointment_statuses ( id );

ALTER TABLE appointments
    ADD CONSTRAINT appointments_appointments_FK FOREIGN KEY ( parent_appointment_id )
        REFERENCES appointments ( id );

ALTER TABLE appointments
    ADD CONSTRAINT appointments_doctor_notes_FK FOREIGN KEY ( doctor_note_id )
...
ALTER TABLE scheduled_visits
    ADD CONSTRAINT scheduled_visits_appointments_FK FOREIGN KEY ( appointment_id )
        REFERENCES appointments ( id );
...
ALTER TABLE unscheduled_visits
    ADD CONSTRAINT unscheduled_visits_appointments_FK FOREIGN KEY ( appointment_id )
        REFERENCES appointments ( id );

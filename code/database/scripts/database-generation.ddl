...
CREATE TABLE application_statuses (
    ...
    NOT NULL,
    type_code VARCHAR2(1 CHAR) NOT NULL,
...
CREATE TABLE applications (
    id                    NUMBER
        GENERATED BY DEFAULT AS IDENTITY ( START WITH 1 NOCACHE ORDER )
    NOT NULL,
    parent_application_id NUMBER NOT NULL,
    patient_id            NUMBER NOT NULL,
    doctor_note_id        NUMBER NOT NULL,
    application_status_id NUMBER NOT NULL,
...
ALTER TABLE applications
    ADD CONSTRAINT applications_application_statuses_FK FOREIGN KEY ( application_status_id )
        REFERENCES application_statuses ( id );

ALTER TABLE applications
    ADD CONSTRAINT applications_applications_FK FOREIGN KEY ( parent_application_id )

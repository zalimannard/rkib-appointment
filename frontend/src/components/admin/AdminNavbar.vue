<template>
  <v-app-bar app>
    ...
    <v-tabs v-model="activeTab">
      <v-tab to="/admin/appointment">Обращения</v-tab>
      <v-tab to="/admin/appointmentstatus">Статусы обр.</v-tab>
      <v-tab to="/admin/employee">Сотрудники</v-tab>
      <v-tab to="/admin/institution">Учреждения</v-tab>
      <v-tab to="/admin/patient">Пациенты</v-tab>
      <v-tab to="/admin/person">Люди</v-tab>
      <v-tab to="/admin/procedure">Услуги</v-tab>
      <v-tab to="/admin/schedule">Графики</v-tab>
      <v-tab to="/admin/schedulestatus">Статусы гр.</v-tab>
    </v-tabs>
    <v-spacer></v-spacer>
    <v-menu offset-y>

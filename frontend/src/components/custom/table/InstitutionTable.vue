...
export default {
  ...
  methods: {
    updateSearch() {
      this.$emit("updateSearchInput", this.institution.name);
      this.onEditFilter();
    },
    ...
    onEditFilter() {
      this.filteredInstitutions = this.filterProcedures(this.institutions);
    },
    ...
    filterProcedure(procedure) {
      ...
      return (
          checkFilter(procedure.name, this.institution.name)
      );
    },
